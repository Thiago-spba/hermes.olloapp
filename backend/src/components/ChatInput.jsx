        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: "13px", color: "#7aada0" }}>
              Imagens, PDF, TXT, código • Máx. 200MB
            </p>
          </div>
        </div>
      )}
        ...
        >
            ...
            {showTools && (
              <>
                ...
                >
                  ...
                  <div
                    onClick={() => {
                      if (!isLoading && !attachedFile && !attachedAudio) {
                        setShowCamera(true);
                        setShowTools(false);
                      }
                    }}
                  ...
                  <div
                    ...
                    onMouseLeave={(e) =>
                      (e.currentTarget.style.backgroundColor = useRAG
                        ? isDark
                          ? "rgba(0,229,255,0.08)"
                          : "rgba(0,200,150,0.08)"
                        : "transparent")
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {useRAG
                            ? "Ativa — buscando nos documentos"
                            : "Inativa — sem consultar documentos"}
                        </span>
                      </div>
                    </div>
                    {/* SWITCH */}
          ...
          <button
            ...
            style={{
              ...
              boxShadow: hasContent ? "0 2px 12px rgba(0,229,170,0.4)" : "none",
            }}
